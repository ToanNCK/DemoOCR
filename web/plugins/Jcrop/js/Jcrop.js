...
(function ($) {
  ...
  var Jcrop = function (element, opt) {
    ...
    if (this.opt.is_ie_lt9) this.opt.dragEventTarget = document.body;
  };
  ...
  $.extend(Jcrop, {
    ...
    propagate: function (plist, config, obj) {
      for (var i = 0, l = plist.length; i < l; i++)
        if (config.hasOwnProperty(plist[i])) obj[plist[i]] = config[plist[i]];
    },
    // }}}
  ...
  $.extend(ImageStage, {
    ...
    create: function (el, options, callback) {
      $.Jcrop.component.ImageLoader.attach(el, function (w, h) {
        ...
        if (typeof callback == "function") callback.call(this, obj, options);
      });
    },
  });
  ...
  $.extend(CanvasStage.prototype, {
    ...
    redraw: function () {
      ...
      this.context.translate(
        parseInt(this.width * 0.5),
        parseInt(this.height * 0.5)
      );
  ...
  $.extend(ShadeFilter.prototype, {
    ...
    init: function () {
      ...
      if (!t.attached) {
        ...
        t.container = $("<div />")
          .addClass(t.core.opt.css_shades)
  ...
  $.extend(ImageLoader, {
    ...
    prototype: {
      getDimensions: function () {
        ...
        if (el.width) return [el.width, el.height];
    ...
    prototype: {
      ...
      shimDragState: function () {
        ...
        $.Jcrop.component.DragState.prototype.initEvents = function (e) {
          ...
          if (e.type.substr(0, 5) == "touch") {
            $(this.eventTarget)
              .on(
                "touchmove.jcrop.jcrop-touch",
                t.dragWrap(this.createDragHandler())
              )
      ...
      shimStageDrag: function () {
        this.core.container
          ...
          .on(
            "touchstart.jcrop.jcrop-stage",
            this.dragWrap(this.core.ui.manager.startDragHandler())
          );
      },
      // }}}
  ...
  $.extend(Selection, {
    ...
    prototype: {
      ...
      startup: function () {
        ...
        t.element = $("<div />")
          .addClass(o.css_selection)
          // .attr('data-id',1)
          .data({ selection: t });
        t.frame = $("<button />")
          .addClass(o.css_button)
          .data("ord", "move")
          .attr("type", "button");
      ...
      clearFilters: function () {
        ...
        for (var i = 0; i < f.length; i++) if (f[i].destroy) f[i].destroy();
      ...
      get: function () {
        var b = this.element,
          o = b.position(),
          w = $(".jcrop-selection").length > 0 ? b.width() : 0,
          h = $(".jcrop-selection").length > 0 ? b.height() : 0,
          rv = { x: o.left, y: o.top };
  ...
  $.extend(StageManager.prototype, {
    ...
    tellConfigUpdate: function (options) {
      for (var i = 0, m = this.ui.multi, l = m.length; i < l; i++)
        if (
          m[i].setOptions &&
          (m[i].linked ||
            (this.core.opt.linkCurrent && m[i] == this.ui.selection))
        )
    ...
    setupEvents: function () {
      ...
      this.core.container.on(
        "mousedown.jcrop.jcrop-stage",
    ...
    prototype: {
      recopyCanvas: function () {
        ...
        this.context.putImageData(
          cxt.getImageData(0, 0, s.canvas.width, s.canvas.height),
          0,
          0
        );
      },
      ...
      show: function () {
        ...
        if (!this.fading) this.element.stop().css({ opacity: 1 });
          ...
          this.element
            .stop()
            .animate({ opacity: 1 }, { duration: 80, queue: false });
      },
      hide: function () {
        var t = this;
        if (!t.fading) t.element.hide();
          ...
          t._hiding = setTimeout(function () {
            ...
            t.element
              ...
              .animate(
                { opacity: 0 },
                { duration: t.fadeDuration, queue: false }
              );
          }, t.fadeDelay);
      },
      initEvents: function () {
        var t = this;
        t.core.container.on(
          "croprotstart croprotend cropimage cropstart cropmove cropend",
          function (e, s, c) {
  ...
  DialDrag.prototype = {
    ...
    remove: function () {
      this.$btn.removeClass("dialdrag").off(".dialdrag").data("dialdrag", null);
      return this;
    },
    ...
    getOffset: function () {
      var targ = this.$targ,
        pos = targ.offset();
      return [pos.left + targ.width() / 2, pos.top + targ.height() / 2];
    },
  ...
  $.extend(Jcrop.prototype, {
    ...
    init: function () {
      ...
      if ($.Jcrop.supportsTouch) new $.Jcrop.component.Touch(this);
    ...
    setOptions: function (opt, proptype) {
      ...
      if (this.opt.setSelect) {
        ...
        if (!this.ui.multi.length) this.newSelection();
    ...
    applyFilters: function () {
      ...
      for (var i = 0, f = this.opt.applyFilters, l = f.length; i < l; i++) {
        if ($.Jcrop.filter[f[i]]) obj = new $.Jcrop.filter[f[i]]();
        obj.core = this;
    ...
    getDefaultFilters: function () {
      ...
      for (var i = 0, f = this.opt.applyFilters, l = f.length; i < l; i++)
        if (this.filter.hasOwnProperty(f[i])) rv.push(this.filter[f[i]]);
    ...
    newSelection: function (sel) {
      if (!sel) sel = new this.opt.selectionComponent();
    ...
    setSelect: function (box) {
      if (this.ui.selection) this.ui.selection.update(Jcrop.wrapFromXywh(box));
      return this;
    },
    // setselect: function(boxs){{{
    setSelectCus: function (boxs) {
      if (this.ui.selection) this.ui.selection.update(Jcrop.wrapFromXywh(boxs));
      return this;
    },
    // }}}
    //startDrag: function(){{{
    startDrag: function () {
      ...
      return function (e) {
        var $targ = $(e.target);
        var selection = $targ
          .closest("." + t.opt.css_selection)
          .data("selection");
        var ord = $targ.data("ord");
        t.container.trigger("cropstart", [
          selection,
          t.unscale(selection.get()),
        ]);
    ...
    setImage: function (src, cb) {
      ...
      new $.Jcrop.component.ImageLoader(src, null, function (w, h) {
        ...
        if (typeof cb == "function") cb.call(t, w, h);
      });
    },
    // }}}
    // update: function(b){{{
  ...
  $.fn.Jcrop = function (options, callback) {
    ...
    this.each(function () {
      ...
      if (exists) exists.setOptions(options);
      else {
        ...
        options.stageConstructor(this, options, function (stage, options) {
          ...
          if (typeof stage.attach == "function") stage.attach(obj);
